...
<div class="module-live-edit-settings" id="module-logo-settings">
    ...
    <div class="mw-ui-field-holder">
        <ul class="mw-ui-inline-list">
            <li><span><?php _e('Logo type'); ?></span></li>
            <li><label class="mw-ui-check"><input type="radio" class="mw_option_field"
                                                  <?php if ($logotype == 'image'){ ?>checked=""<?php } ?>
                                                  name="logotype"
                                                  value="image"><span></span><span><?php _e('Image'); ?></span></label>
            </li>
            <li><label class="mw-ui-check"><input type="radio" class="mw_option_field"
                                                  <?php if ($logotype == 'text'){ ?>checked=""<?php } ?> name="logotype"
                                                  value="text"><span></span><span><?php _e('Text'); ?></span></label>
            </li>
            <li><label class="mw-ui-check"><input type="radio" class="mw_option_field"
                                                  <?php if ($logotype == 'both' or $logotype == false){ ?>checked=""<?php } ?>
                                                  name="logotype"
                                                  value="both"><span></span><span><?php _e('Both'); ?></span></label>
            </li>
        </ul>
    </div>
    <div class="mw-ui-field-holder">
        ...
        <div class="mw-ui-box mw-ui-box-content">
            <div class="mw-ui-row-nodrop image-row">
                ...
                <div class="mw-ui-col the-image-holder">
                    <img src="<?php print $logoimage; ?>" class="pull-left the-image"
                         alt="" <?php if ($logoimage != '' and $logoimage != false) { ?><?php } else { ?> style="display:block;" <?php } ?> />
                    <br>
                    ...
                    <br>
                    <label class="mw-ui-check"><input type="checkbox" checked="" id="order_status1"
                ...
                <div class="mw-ui-col">
                    ...
                    <div class="mw-ui-row-nodrop">
                        ...
                        <div class="mw-ui-col" style="width: 190px;">
                            <div class="mw-ui-col-container">

                                <div class="mw-ui-field-hoilder" style="padding-bottom: 20px;"><input type="text"
                                                                                                      class="mw-ui-field mw-ui-filed-big mw_option_field w100"
                                                                                                      placeholder="<?php _e('Enter Text'); ?>"
                ...
                <input type="hidden" class="mw_option_field" name="font_size" id="font_size"/>
                <script>
                    $(function () {
                        $("#sizeslider").slider({
